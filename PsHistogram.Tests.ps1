...
Import-Module PsHistogram

$here = Split-Path -Parent $MyInvocation.MyCommand.Path

$manifestPath   = "$here\PsHistogram.psd1"
...
Describe 'manifest and changelog' {
    ...
    It 'has a valid name in the manifest' {
        $script:manifest.Name | Should Be PsHistogram
    }

    It 'has a valid guid in the manifest' {
        $script:manifest.Guid | Should Be 'c463a89e-7e5a-486c-9f89-614385d366f4'
    }
...
Describe 'Style rules' {
    $moduleRoot = (Get-Module PsHistogram).ModuleBase
